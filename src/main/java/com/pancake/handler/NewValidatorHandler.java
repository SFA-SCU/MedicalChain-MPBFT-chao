 ...
 */
public class NewValidatorHandler implements Runnable {
    private final static Logger logger = LoggerFactory.getLogger(NewValidatorHandler.class);
    private final static ObjectMapper objectMapper = new ObjectMapper();
    private final Socket socket;
    private CommitMessageService cmtms = new CommitMessageService();
    private NetAddress validatorAddr;

    public NewValidatorHandler(Socket socket, NetAddress validatorAddr) {
        this.socket = socket;
